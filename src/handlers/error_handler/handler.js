...
function init_checker(msg, question=null){
	if(question == 'NAME'){
		...
		if(msg.parsed_msg.parse == parser_constants['SINGLE_ELIM'] || msg.parsed_msg.parse == parser_constants['DOUBLE_ELIM'] || msg.parsed_msg.parse == parser_constants['SWISS'] || msg.parsed_msg.parse == parser_constants['ROUND_ROBIN']){
			return [true, question];
		}
		...
		if(msg.parsed_msg.parse == parser_constants['NO_TEAMS'] || msg.parsed_msg.parse == parser_constants['YES_TEAMS']){
			return [true, question]
		}
		else if(msg.parsed_msg.data_object.answered != null){
			return [true, msg.parsed_msg.data_object.answered];
		...
		if(msg.parsed_msg.parse == parser_constants['CAP'] || msg.parsed_msg.parse == parser_constants['NO_CAP']){
			return [true, question]
		}
		else if(msg.parsed_msg.data_object.answered != null){
			return [true, msg.parsed_msg.data_object.answered];
